...
| [Arm AMBA — 6-part Presentation Series](https://brendanjameslynskey.github.io/AMBA/) | Six Reveal.js decks (~124 slides total) covering Arm's Advanced Microcontroller Bus Architecture end-to-end: history of AMBA (1996 → 2024), AHB &amp; APB protocols, AXI deep dive (channels, bursts, IDs, ordering, QoS, Lite &amp; Stream), ACE &amp; ACE-Lite coherency, CHI scalable multi-cluster coherency (CMN-600/650/700), and the future (CHI-C2C, UCIe chiplets, CXL, MPAM, RME / CCA, AI accelerators) — with interactive AMBA-generation and burst-type pickers |
